...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $req = $pdo->prepare('INSERT INTO cibles(nom, prenom, date_naissance, nom_code, nationalite) VALUES(:nom, :prenom, :date_naissance, :nom_code, :nationalite)');
        $req->execute(array(
            'nom' => $nom,
            'prenom' => $prenom,
    ...
    <div class="form_cible">

        <form action="ajout_cible.php" method="POST">
            <h2><strong>Ajouter une cible</strong></h2>
