...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        // Hashage du code d'identification
        $code_identification_hash = password_hash($code_identification, PASSWORD_DEFAULT);



        // Insertion des données dans la table agents
        $req = $pdo->prepare('INSERT INTO agents(nom, prenom, date_naissance, code_identification_hash, nationalite, specialites) VALUES(:nom, :prenom, :date_naissance, :code_identification_hash, :nationalite, :specialites)');
        $req->execute(array(
            'nom' => $nom,
            'prenom' => $prenom,
            'date_naissance' => $date_naissance,
            'code_identification_hash' => $code_identification_hash,
    ...
    <div class="form_agent">
        ...
        <form action="ajout_agent.php" method="POST">
            <h2><strong>Ajouter un agent</strong></h2>
            ...
            <input type="text" id="code_identification" name="code_identification" required>
            <br><br>
            ...
            <input type="text" id="nouveau_type" name="nouveau_type" placeholder="Entrez un nouveau pays">
            <button type="button" onclick="ajouterType()">Ajouter un pays</button>
            <br><br>
